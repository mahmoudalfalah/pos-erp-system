...
export const createCategorySchema = z.object({
    ...
    slug: z
        ...
        .regex(/^[a-z0-9]+(?:-[a-z0-9]+)*$/, "Category slug must be URL-friendly (lowercase letters, numbers, and hyphens only)"),
    isActive: z
        .boolean()
        .default(true)
})
...
export const validateCreateCategoryInput = (data: unknown): Result<CreateCategoryInput> => {
